...
class PixivRankingTagFilterSpiderMiddleware:
...
class PixivRankingTagFilterDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class PixivUserAgentMiddleware(object):
...
class PixivRefererMiddleware(object):
